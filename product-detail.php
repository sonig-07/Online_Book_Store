            ...
            <div class="row no-gutters">
                    ...
                    <form action="cart.php?action=add&id=<?php echo $row["id"]; ?>" method="POST">
                        ...
                        <article class="gallery-wrap">
                            <div class="img-big-wrap">
                                <a href="#"><img src="admin/img/<?php echo $row['img']; ?>"></a>
                            </div> <!-- img-big-wrap.// -->
                ...
                <main class="col-md-6 border-left">
                    <article class="content-body">
                        ...
                        <input type="submit" name="add" class="btn btn-block btn-success" value="Add to cart">
            ...
            <div class="col-md-9">
                ...
                <article class="box mb-3">
                    <div class="icontext w-100">
                        ...
                        <div class="text">
                            <span class="date text-muted float-md-right">02.02.2022 </span>
